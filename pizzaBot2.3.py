...
def save_order(size, topping, drink, crust, price):
    with open("orders.txt", "a") as file:  # "a" means append mode
...
def cancel_order():
    ...
    update_chat("PizzaBot: Sorry to hear that! Come back any time. We always welcome you! 🍕🥤")

# Main window
root = tk.Tk()
root.title("PizzaBot v3.2 - Save Orders")
